...
syms u1 u2 u3 x(u1,u2,u3) y(u1,u2,u3) z(u1,u2,u3) h1 h2 h3
...
while true 
    ...
    elseif choice==2
        ...
        h1=simplify(sqrt(rdx(1)^2+rdy(1)^2+rdz(1)^2));
        h2=simplify(sqrt(rdx(2)^2+rdy(2)^2+rdz(2)^2));
        h3=simplify(sqrt(rdx(3)^2+rdy(3)^2+rdz(3)^2));
        break
